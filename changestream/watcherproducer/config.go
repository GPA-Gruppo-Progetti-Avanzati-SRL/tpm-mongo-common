...
type WatcherConfigOption func(*WatcherConfig)

func WithRetryCount(retryCount int) WatcherConfigOption {
	return func(options *WatcherConfig) {
		options.RetryCount = retryCount
	}
}

func WithCheckpointSvc(svc checkpoint.ResumeTokenCheckpointSvc) WatcherConfigOption {
	return func(options *WatcherConfig) {
		options.CheckPointSvc = svc
	}
}

func (cfg *WatcherConfig) ChangeStreamOptions() (*options.ChangeStreamOptionsBuilder, error) {
	const semLogContext = "watcher::config-change-stream-options"
...
func (cfg *WatcherConfig) Pipeline() (mongo.Pipeline, error) {
...
func (cfg *WatcherConfig) OnWatcherErrorPolicy() string {
...
func (cfg *WatcherConfig) onConsumerErrorPolicy() string {
	if cfg.OnErrorPolicy == "" {
		return OnErrorPolicyContinue
	}
	return cfg.OnErrorPolicy
...
var defaultChangeStreamOptions = options.ChangeStreamOptions{
	BatchSize:                nil,
	Collation:                nil,
	Comment:                  nil,
	FullDocument:             nil,
